...
class Category(MPTTModel):
    ...
    slug = models.SlugField(verbose_name=_(
        "Category safe URL"), max_length=520, unique=True)
...
class ProductType(models.Model):
    ...
    name = models.CharField(verbose_name=_("Product Name"), help_text=_(
        "Required"), max_length=520, unique=True)
    is_active = models.BooleanField(default=True)
...
class ProductSpecification(models.Model):
    ...
    name = models.CharField(verbose_name=_(
        "Name"), help_text=_("Required"), max_length=520)
...
class Product(models.Model):
    ...
    save_for_later = models.ManyToManyField(
        settings.AUTH_USER_MODEL, related_name="user_save_for_later", blank=True)
...
def calculate_discount_percentage(sender, instance, *args, **kwargs):
    ...
    if instance.regular_price and instance.discount_price:
        discount_percentage = (
            (instance.regular_price - instance.discount_price) / instance.regular_price) * 100
